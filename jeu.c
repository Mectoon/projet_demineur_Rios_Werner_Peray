...
#include <stdlib.h>
#include <time.h>
#include <windows.h> // include pour le compteur de 3s (aide de l'ia)
...
void calculer_score(Partie *p){
    ...
    temps_fin = time(NULL); // récupération heure actuelle

    duree = (int)(temps_fin - p->temps); // temps mis dans la partie
